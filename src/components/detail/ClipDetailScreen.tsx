    ...
    >
      ...
      {chatOpen ? null : (
        <button
          ...
          className="rounded-pill border-hairline-strong bg-panel-solid shadow-glass-lg text-ink hover:text-accent fixed right-6 bottom-6 z-30 flex cursor-pointer items-center gap-2 border px-4 py-2.5 text-[13px] transition-colors duration-150"
        >
